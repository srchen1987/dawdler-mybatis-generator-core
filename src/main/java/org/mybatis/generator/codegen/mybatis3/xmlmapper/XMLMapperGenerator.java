...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.SelectPageListCountElementGenerator;
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.SelectPageListElementGenerator;
...
public class XMLMapperGenerator extends AbstractXmlGenerator {
	...
	protected XmlElement getSqlMapElement() {
		...
		addSelectPageListCountElement(answer);
		addSelectPageListElement(answer);
		return answer;
	}
	...
	protected void addSelectPageListCountElement(XmlElement parentElement) {
		if (this.introspectedTable.getRules().generateSelectPageListCount()) {
			SelectPageListCountElementGenerator selectPageListCountElementGenerator = new SelectPageListCountElementGenerator();
			initializeAndExecuteGenerator((AbstractXmlElementGenerator) selectPageListCountElementGenerator,
					parentElement);
		}
	}

	protected void addSelectPageListElement(XmlElement parentElement) {
		if (this.introspectedTable.getRules().generateSelectPageList()) {
			SelectPageListElementGenerator selectPageListElementGenerator = new SelectPageListElementGenerator();
			initializeAndExecuteGenerator((AbstractXmlElementGenerator) selectPageListElementGenerator, parentElement);
		}
	}
