...
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.SelectPageListCountMethodGenerator;
import org.mybatis.generator.codegen.mybatis3.javamapper.elements.SelectPageListMethodGenerator;
...
public class JavaMapperGenerator extends AbstractJavaClientGenerator {
	...
	public List<CompilationUnit> getCompilationUnits() {
		...
		addSelectPageListCountMethod(interfaze, true);
		addSelectPageListMethod(interfaze, true);
	...
	public void addSelectPageListCountMethod(Interface interfaze, boolean isSimple) {
		if (this.introspectedTable.getRules().generateSelectPageListCount()) {
			SelectPageListCountMethodGenerator selectPageListCountMethodGenerator = new SelectPageListCountMethodGenerator(
					isSimple);
			initializeAndExecuteGenerator((AbstractJavaMapperMethodGenerator) selectPageListCountMethodGenerator,
					interfaze);
		}
	}

	protected void addSelectPageListMethod(Interface interfaze, boolean isSimple) {
		if (this.introspectedTable.getRules().generateSelectPageList()) {
			SelectPageListMethodGenerator selectPageListMethodGenerator = new SelectPageListMethodGenerator(isSimple);
			initializeAndExecuteGenerator((AbstractJavaMapperMethodGenerator) selectPageListMethodGenerator, interfaze);
		}
	}
