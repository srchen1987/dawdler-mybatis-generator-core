...
public class Context extends PropertyHolder {
	...
	/**
	 * This method could be useful for users that use the library for introspection
	 * only and not for code generation.
	 *
	 * @return a list containing the results of table introspection. The list will
	 *         be empty if this method is called before introspectTables(), or if no
	 *         tables are found that match the configuration
	 */
	...
	public void generateFiles(ProgressCallback callback, List<GeneratedJavaFile> generatedJavaFiles,
		...
		// initialize everything first before generating. This allows plugins to know
		// about other
	...
	/**
	 * This method creates a new JDBC connection from the values specified in the
	 * configuration file. If you call this method, then you are responsible for
	 * closing the connection (See {@link Context#closeConnection(Connection)}). If
	...
	/**
	 * This method closes a JDBC connection and ignores any errors. If the passed
	 * connection is null, then the method does nothing.
	 *
