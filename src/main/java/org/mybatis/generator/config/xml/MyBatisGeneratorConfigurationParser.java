...
public class MyBatisGeneratorConfigurationParser {
	...
	/**
	 * This method resolve a property from one of the three sources: system
	 * properties, properties loaded from the &lt;properties&gt; configuration
	 * element, and "extra" properties that may be supplied by the Maven or Ant
	 * environments.
	 *
	 * <p>
	 ...
	 * @return the resolved property. This method will return null if the property
	 *         is undefined in any of the sources.
	 */
