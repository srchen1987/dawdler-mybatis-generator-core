...
public class LogFactory {
	 ...
	 * This is useful in situations where you want to use Java native logging to log
	 * activity but Log4J is on the classpath. Note that this method is only
	 * effective for log classes obtained after calling this method. If you intend
	 * to use this method you should call it before calling any other method.
	 */
