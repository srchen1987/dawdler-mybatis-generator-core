...
public class ObjectFactory {
	...
	/**
	 * Clears the class loaders. This method should be called at the beginning of a
	 * generation run so that and change to the classloading configuration will be
	 * reflected. For example, if the eclipse launcher changes configuration it
	 ...
	 * generator's classes or interfaces. Examples are JDBC drivers, root classes,
	 * root interfaces, etc.
	 *
	...
	/**
	 * Returns a class loaded from the context classloader, or the classloader
	 * supplied by a client. This is appropriate for JDBC drivers, model root
	 * classes, etc. It is not appropriate for any class that extends one of the
	...
	/**
	 * Creates an introspected table implementation that is only usable for
	 * validation .
	 *
	 *
