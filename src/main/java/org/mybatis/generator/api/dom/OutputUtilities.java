...
public class OutputUtilities {
	...
	/**
	 * Utility method that indents the buffer by the default amount for Java (four
	...
	/**
	 * Utility method that indents the buffer by the default amount for Kotlin (four
	 * spaces per indent level).
	 *
	 * @param sb          a StringBuilder to append to
	 * @param indentLevel the required indent level
