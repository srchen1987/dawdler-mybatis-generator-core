...
public interface ShellCallback {
	 ...
	 *
	 * <p>
	 * The default shell callback interprets both values as directories and simply
	 * concatenates the two values to generate the default directory.
	 *
	 * @param targetProject the target project
	 * @param targetPackage the target package
	 * @return the directory (must exist)
	 * @throws ShellException if the project/package cannot be resolved into a
	 *                        directory on the file system. In this case, the
	 *                        generator will not save the file it is currently
	 *                        working on. The generator will add the exception
	 ...
	 * existing file. This method should return the merged source (formatted). The
	 * generator will write the merged source as-is to the file system.
	 *
	 * <p>
	 * A merge typically follows these steps:
	 * <ol>
	 * <li>Delete any methods/fields in the existing file that have the specified
	 * JavaDoc tag</li>
	 ...
	 * @param javadocTags   the JavaDoc tags that denotes which methods and fields
	 *                      in the old file to delete (if the Java element has any
	 *                      of these tags, the element is eligible for merge)
	 * @param fileEncoding  the file encoding for reading existing Java files. Can
	 *                      be null, in which case the platform default encoding
	 *                      will be used.
	 ...
	 *                        existing file will remain undisturbed. The generator
	 *                        will add the exception message to the list of warnings
	 *                        automatically.
	 */
	...
	/**
	 * After all files are saved to the file system, this method is called once for
	 * each unique project that was affected by the generation run. This method is
	 * useful if your IDE needs to be informed that file system objects have been
	 * created or updated. If you are running outside of an IDE, your implementation
	 * need not do anything in this method.
	 *
	 ...
	 * This method will be called only if <code>isMergeSupported()</code> returns
	 * <code>false</code> and a file exists that would be overwritten by a generated
	 * file. If you return <code>true</code>, then we will log a warning specifying
	 * what file was overwritten.
	 *
