...
public interface JavaTypeResolver {
	 ...
	 * displayed to the user. The concept of a warning is that code generation can
	 ...
	 * @return the calculated type, or null if an unsupported data type. If null is
	 *         returned, we will set the type to Object and issue a warning unless
	...
	/**
	 * Calculates and returns the JDBC type name that should be associated with this
	 * column based on the jdbc type, length, and scale of the column.
	 *
	 * @param introspectedColumn the column whose Java type needs to be calculated
	 * @return the calculated type name, or null if an unsupported data type. If
	 *         null is returned, we will set the type to OTHER and issue a warning
