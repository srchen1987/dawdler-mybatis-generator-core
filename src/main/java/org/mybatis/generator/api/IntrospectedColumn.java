...
public class IntrospectedColumn {
	...
	/**
	 * The platform specific data type name as reported from
	...
	/**
	 * Constructs a Column definition. This object holds all the information about a
	 * column that is required to generate Java objects and SQL maps;
	 */
	...
	/**
	 * The platform specific type name as reported by the JDBC driver. This value is
	 * determined from the DatabaseMetadata.getColumns() call - specifically
	 * ResultSet.getString("TYPE_NAME"). This value is platform dependent.
	 *
